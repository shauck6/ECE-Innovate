...
void VSamProcessor___024root___eval_act(VSamProcessor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VSamProcessor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSamProcessor___024root___eval_act\n"); );
}

VL_INLINE_OPT void VSamProcessor___024root___nba_sequent__TOP__0(VSamProcessor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VSamProcessor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSamProcessor___024root___nba_sequent__TOP__0\n"); );
    // Init
...
void VSamProcessor___024root___eval_nba(VSamProcessor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VSamProcessor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSamProcessor___024root___eval_nba\n"); );
    // Body
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VSamProcessor___024root___nba_sequent__TOP__0(vlSelf);
    }
}

void VSamProcessor___024root___eval_triggers__act(VSamProcessor___024root* vlSelf);

bool VSamProcessor___024root___eval_phase__act(VSamProcessor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VSamProcessor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSamProcessor___024root___eval_phase__act\n"); );
    // Init
    VlTriggerVec<1> __VpreTriggered;
    CData/*0:0*/ __VactExecute;
    // Body
    VSamProcessor___024root___eval_triggers__act(vlSelf);
    __VactExecute = vlSelf->__VactTriggered.any();
    if (__VactExecute) {
        __VpreTriggered.andNot(vlSelf->__VactTriggered, vlSelf->__VnbaTriggered);
        vlSelf->__VnbaTriggered.thisOr(vlSelf->__VactTriggered);
        VSamProcessor___024root___eval_act(vlSelf);
    }
    return (__VactExecute);
}

bool VSamProcessor___024root___eval_phase__nba(VSamProcessor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VSamProcessor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSamProcessor___024root___eval_phase__nba\n"); );
    // Init
    CData/*0:0*/ __VnbaExecute;
    // Body
    __VnbaExecute = vlSelf->__VnbaTriggered.any();
    if (__VnbaExecute) {
        VSamProcessor___024root___eval_nba(vlSelf);
...
void VSamProcessor___024root___eval(VSamProcessor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VSamProcessor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSamProcessor___024root___eval\n"); );
    // Init
...
#ifdef VL_DEBUG
            VSamProcessor___024root___dump_triggers__nba(vlSelf);
#endif
            VL_FATAL_MT("SamProcessor.v", 6, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("SamProcessor.v", 6, "", "Active region did not converge.");
            }
            vlSelf->__VactIterCount = ((IData)(1U) 
                                       + vlSelf->__VactIterCount);
            vlSelf->__VactContinue = 0U;
            if (VSamProcessor___024root___eval_phase__act(vlSelf)) {
                vlSelf->__VactContinue = 1U;
            }
        }
        if (VSamProcessor___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
...
void VSamProcessor___024root___eval_debug_assertions(VSamProcessor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VSamProcessor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSamProcessor___024root___eval_debug_assertions\n"); );
    // Body
