...
#ifdef VL_DEBUG
VL_ATTR_COLD void VProcessor___024root___dump_triggers__stl(VProcessor___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool VProcessor___024root___eval_phase__stl(VProcessor___024root* vlSelf);
...
#ifdef VL_DEBUG
            VProcessor___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("Processor.v", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (VProcessor___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void VProcessor___024root___dump_triggers__stl(VProcessor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VProcessor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VProcessor___024root___dump_triggers__stl\n"); );
    // Body
...
void VProcessor___024root___ico_sequent__TOP__0(VProcessor___024root* vlSelf);

VL_ATTR_COLD void VProcessor___024root___eval_stl(VProcessor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VProcessor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VProcessor___024root___eval_stl\n"); );
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
...
VL_ATTR_COLD void VProcessor___024root___eval_triggers__stl(VProcessor___024root* vlSelf);

VL_ATTR_COLD bool VProcessor___024root___eval_phase__stl(VProcessor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VProcessor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VProcessor___024root___eval_phase__stl\n"); );
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    VProcessor___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelf->__VstlTriggered.any();
    if (__VstlExecute) {
        VProcessor___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void VProcessor___024root___dump_triggers__ico(VProcessor___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VProcessor__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VProcessor___024root___dump_triggers__ico\n"); );
    // Body
